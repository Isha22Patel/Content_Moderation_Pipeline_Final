    ...
    <div className="page">
      ...
      <div className="card">
        <div className="flex-between" style={{ marginBottom: 16 }}>
          ...
          <Link href="/moderate" className="btn btn-ghost btn-sm">
            + Moderate Content
          </Link>
        </div>
              ...
              <tbody>
                {records.map((r) => (
                  <tr key={r.id}>
                    ...
                    <td><span className="muted">{r.policyName}</span></td>
                    <td><div className="content-preview">{r.content}</div></td>
                    <td><RoutingBadge routing={r.routing} /></td>
                    <td><ActionBadge action={r.action} /></td>
                    <td className="muted small">{r.latencyMs}ms</td>
                  </tr>
                ))}
              </tbody>
            </table>
